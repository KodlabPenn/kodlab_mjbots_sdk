...
std::vector<float> kodlab::RobotBase::GetJointPositions() {  // Copy of
                                                             // positions
...
std::vector<float>
kodlab::RobotBase::GetJointVelocities() {  // Copy of velocities
  std::vector<float> vel(velocities_.begin(), velocities_.end());
  return vel;
}

std::vector<std::shared_ptr<kodlab::JointBase>> kodlab::RobotBase::GetJoints(
...
std::vector<float>
kodlab::RobotBase::GetJointTorqueCmd() {  // Cop of torque_cmds
