...
namespace kodlab::rotations
{
   ...
   * @note Default convention is X-Y-Z Extrinsic Euler angles.
   *
  ...
  struct EulerAngles
  {
    static_assert(std::is_arithmetic<Scalar>::value, "Euler angles must have a numeric type.");
     ...
     * the \b X-Y-Z \b Extrinsic (Tait-Bryan) Euler angle convention.
     *
     */
     ...
     */
    EulerAngles(const Scalar &roll_in, const Scalar &pitch_in, const Scalar &yaw_in)
  ...
  const void ASSERT_DEFAULT_EULER_CONVENTION(const EulerAngles<Scalar> &euler)
  {
    static_assert((euler.axes == DEFAULT_EULER_ANGLE_AXES) &&
                      (euler.rot_type == DEFAULT_EULER_ANGLE_ROTATION_TYPE),
                  "Method only supports X-Y-Z Extrinsic Euler angle convention.");
  }
  ...
  /**
   * @brief
   * @cite https://github.com/RobotLocomotion/drake/blob/5022e3832e90f988f1b6d3015b2794ea26e527b1/math/roll_pitch_yaw.h#L159
   *
   * @tparam Scalar
   * @param euler
  ...
  /**
   * @brief
   * @cite https://github.com/RobotLocomotion/drake/blob/5022e3832e90f988f1b6d3015b2794ea26e527b1/math/rotation_matrix.h#L146
   *
   * @tparam Scalar
   * @param euler
  ...
  /**
   * @brief Constructs a 3x3 rotation matrix from a Quaternion.
   * @cite https://github.com/RobotLocomotion/drake/blob/5022e3832e90f988f1b6d3015b2794ea26e527b1/math/rotation_matrix.h#L970
   *
   * @tparam Scalar
   * @param quaternion
  ...
  /**
   * @brief
   * @cite https://github.com/RobotLocomotion/drake/blob/5022e3832e90f988f1b6d3015b2794ea26e527b1/math/roll_pitch_yaw.cc#L112
   *
   * @tparam Scalar
   * @param quaternion
   * @param R
